...
namespace SleepController.Messages
{
    /// <summary>
    ...
    public class SystemTime
    {
        ...
        public SystemTime() : this(DateTime.Now)
        {
        }
    ...
    /// </summary>
    public class SleepControllerMessage
    {
        /// <summary>
        /// Код - всегда 6
        /// </summary>
        ...
        public SleepControllerMessage(byte[] Buffer)
        {
            if (Marker == BitConverter.ToInt32(Buffer, 0))
            {
                B_time = new SystemTime();
